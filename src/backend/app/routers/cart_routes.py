...
async def get_product_cart(
    gmail: Gmail_User, depends: Annotated[str, Depends(combine_verify)]
):
...
async def add_product_cart(
    add: Add_Product_Cart, depends: Annotated[str, Depends(combine_verify)]
):
...
async def remove_product_cart(
    delete: Delete_Product_Cart, depends: Annotated[str, Depends(combine_verify)]
):
